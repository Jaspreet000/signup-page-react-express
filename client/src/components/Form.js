                ...
                <div className='mt-5'>
                    <form onSubmit={validateFormInput}>
                        ...
                        <div className='mt-2 flex flex-col justify-between items-start'>
                            <Link to="/forgot-password" className='font-medium mb-3 text-base text-violet-500'>Forgot password</Link>
                            <div>
                                <input
                                    type="checkbox"
                                    id='remember'
                                ...
                                />
                                <label className='ml-2 font-medium text-base' htmlFor="remember"> Agree to the terms and conditions.</label>
                            </div>
                        </div>
                        <div className='mt-8 flex flex-col gap-y-4'>
                            <input
                                ...
                                value="Sign in"
                            />
                            <button className='border-2 py-3 rounded-xl border-gray-200 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.02] ease-in-out flex items-center justify-center gap-2'>
